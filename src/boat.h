...
public:
    ...
    Boat(int c) : 
        numBoatGoods(0), tarPos(-1), boatStatus(1), capacity(c), tarX(0), tarY(0), curX(0), curY(0),
        lastX(0), lastY(0), dire(0), idxInPth(0), boatMoveState(BOAT_WAITING), boatPathState(NO_BOAT_PATH) 
    {}
};
